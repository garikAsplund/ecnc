...
<div class="relative min-h-screen w-full">
	...
	<div
		class="mt-[calc(var(--nav-height)+12px)] flex min-h-[calc(100vh-5rem)] w-full flex-col items-center space-y-8 px-8"
	...
	>
		...
		<a
			href="/events"
			aria-label="Ski swap"
			class="text-center text-lg underline underline-offset-2 backdrop-blur-sm hover:opacity-75"
		...
		<a
			...
			target="_blank"
			rel="noopener"
			class="flex w-full justify-center px-2 py-4 text-center underline underline-offset-2 backdrop-blur-0 hover:opacity-75 md:hidden"
		>
